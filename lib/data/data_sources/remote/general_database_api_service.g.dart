...
class _GeneralDatabaseApiService implements GeneralDatabaseApiService {
  _GeneralDatabaseApiService(
    ...
    baseUrl ??= 'https://nook-pal-api.onrender.com';
  }
  ...
  Future<HttpResponse<FineModel>> getFine({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<FineModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<List<FineModel>>> getFinesByUser({
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<FineModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<InventoryModel>> getInventory({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<InventoryModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<List<InventoryModel>>> getInventoryForItem({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<InventoryModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<LoanModel>> getLoan({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<LoanModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<List<LoanModel>>> getLoansByUser({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<HttpResponse<List<LoanModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<NotificationModel>> getNotification({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<NotificationModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<PhysicalBookModel>> getPhysicalBook({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<PhysicalBookModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<ReferenceModel>> getReference({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ReferenceModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
  ...
  Future<HttpResponse<List<String>>> getRelatedSubjects({
    ...
    final _result = await _dio.fetch<List<dynamic>>(
      ...
      contentType: contentType,
            ...
            .compose(
              _dio.options,
              '/sub-book-relations/related-subjects/${bookId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<HttpResponse<List<String>>> getRelatedBooks({
    ...
    final _result = await _dio.fetch<List<dynamic>>(
      ...
      contentType: contentType,
            ...
            .compose(
              _dio.options,
              '/sub-book-relations/related-books/${subjectId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<HttpResponse<SubjectModel>> getSubject({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<SubjectModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
